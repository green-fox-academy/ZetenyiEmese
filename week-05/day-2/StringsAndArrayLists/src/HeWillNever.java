...
public class HeWillNever {
    public static void main(String... args){
        ...
        System.out.println(decrypt(notSoCrypticMessage, map));
    }

    public static String decrypt(int[] cryptedMessage, Map lookUpTable){
        String message = "";
        for (int i = 0; i < cryptedMessage.length; i++) {
            message += lookUpTable.get(cryptedMessage[i]);
        }
        return  message;
    }
}
